var zhufengEvent = (function () {
    function processThis(callBack, context) {
        var outerArg = Array.prototype.slice.call(arguments, 2);//此处arguments存的是processThis里的形参集合
        return function () {
            var innerArg = Array.prototype.slice.call(arguments, 0);//此处arguments存的是匿名函数里的形参
